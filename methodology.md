...
**ML-Driven Dispersion Trading on the S&P 500** — MSc Financial Engineering Applied
Project, Imperial College London.

This is the full **methodological reference** behind the results summarised in the
[README](README.md): every design choice is justified, with the underlying mathematics
and the week-by-week research log, in the sections below. It is intentionally long and
detailed — read the README first for the short version.
